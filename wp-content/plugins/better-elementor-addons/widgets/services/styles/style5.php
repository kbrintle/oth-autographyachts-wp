<div class="better-services style-5">
    <div class="item <?php if ( ! empty( $settings['image']['url'] ) ) { echo 'better-bg-img';} ?> wow fadeInUp" data-wow-delay=".3s" data-background="<?php echo esc_url( $settings['image']['url'] ); ?>">
        <span class="better-services-icon icon <?php echo esc_attr( $settings['style4_item_icon'] ); ?>"></span>
        <h6 class="better-services-title mb-20"><?php echo esc_html( $settings['title'] ); ?></h6>
        <p class="better-services-text"><?php echo esc_html( $settings['text'] ); ?></p>
